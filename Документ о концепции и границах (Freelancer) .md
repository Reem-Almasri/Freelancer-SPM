...
Пользователи разделены на работника и работодателя. 

Работодатели имееют возможность опубликовать разовую работу на сайт со всей информацией и максимальной ценой, которую они могут заплатить за выполнение этой работы.

Ищущие работу в свою очередь могут видеть доступные заказы и откликаться на них. 

После отклика работодатель может взаимодействовать с откликнувшимся - отказать или принять.
...
После выполнения оба оставляют отзыв, все результаты записываются в статистику.
